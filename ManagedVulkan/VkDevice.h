...
namespace ManagedVulkan
{
	...
	public:
		...
		//	ManagedVulkan::Result GetQueryPoolResults(ManagedVulkan::QueryPool^ queryPool, UInt32 firstQuery, UInt32 queryCount, IntPtr dataSize, IntPtr pData, UInt64 stride, UInt32 flags);
